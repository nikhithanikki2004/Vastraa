...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="container mx-auto flex items-center justify-between py-4 px-6">
        {/* Left - Logo */}
        <div>
            <Link to="/" className="text-3xl font-bold tracking-widest bg-gradient-to-r from-pink-400 via-rose-300 to-blue-300 bg-clip-text text-transparent transition duration-300 hover:scale-105">
            VASTRAA
            </Link>
        </div>
        ...
        <div className="hidden md:flex space-x-6">
            ...
            <Link to="/collections/all?gender=Women" className="text-gray-700 hover:text-rose-500 transition-colors duration-200">
            WOMEN
            </Link>
            <Link to="/collections/all?category=Top Wear" className="text-gray-700 hover:text-rose-500 transition-colors duration-200">
            TOP WEAR
            </Link>
            <Link to="/collections/all?category=Bottom Wear"className="text-gray-700 hover:text-rose-500 transition-colors duration-200">
            BOTTOM WEAR
            </Link>
        </div>
        {/* right - Icons */}
